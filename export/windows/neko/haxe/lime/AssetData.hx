...
class AssetData {
	...
	public static function initialize():Void {
		...
		if (!initialized) {
			...
			path.set ("assets/images/enemies/curveaSheet.png", "assets/images/enemies/curveaSheet.png");
			type.set ("assets/images/enemies/curveaSheet.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("assets/music/BossMusic.wav", Reflect.field (AssetType, "sound".toUpperCase ()));
